...
class FollowUpModel(BaseModel):
    ...
    follow_account = models.ForeignKey(User, on_delete=models.CASCADE, related_name='followup', null=True, blank=True, verbose_name='跟进人')
    follow_way = models.ForeignKey(FollowWaysModel, on_delete=models.CASCADE, related_name='followup', null=True, blank=True, verbose_name='跟进方式')
    ...
    marking = models.IntegerField(default=1, null=False, blank=False, verbose_name='绩效打标')  # 1不打标  2新加意向  3回访意向 4合作转接 5特殊延伸 6成交 7客户跟踪
    intentional = models.IntegerField(default=1, choices=((1, 'D'), (2, 'C'), (3, 'B'), (4, 'A')), null=True, blank=True, verbose_name='意向度')
    ...
    sales_stage = models.ForeignKey(SalesStageModel, on_delete=models.CASCADE, related_name='follows_sales_stage', null=True, blank=True, verbose_name='销售阶段')
    ...
    # review = models.ForeignKey(ReviewModel, on_delete=models.CASCADE, related_name='followup', null=True, blank=True, verbose_name='跟进记录审批')
    # order = models.ForeignKey(OrderModel, on_delete=models.CASCADE, related_name='followup', null=True, blank=True, verbose_name='成交订单')
    customer = models.ForeignKey(CustomerModel,on_delete=models.CASCADE, related_name='followup', blank=True, verbose_name='关联联系人')
