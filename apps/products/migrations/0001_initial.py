    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updatedAt', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('service_price', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='价格')),
                ('service_minimum_price', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='最低价格')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unified_price_year', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='年度统一报价')),
                ...
                ('platform', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product', to='products.productplatformmodel', verbose_name='产品平台')),
                ('service_time', models.ManyToManyField(blank=True, related_name='product', to='products.ServiceTimeModel', verbose_name='服务次数套餐')),
                ('type', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product', to='products.producttypemodel', verbose_name='产品类型')),
            ],
            options={
                'verbose_name': '产品',
