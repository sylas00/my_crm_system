...
class ServiceTimeModel(BaseModel):
    ...
    service_minimum_price = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True,
                                                verbose_name='最低价格')
...
class ProductModel(BaseModel):
    ...
    platform = models.ForeignKey(ProductPlatformModel, related_name='product', on_delete=models.CASCADE, default=None,
                                 null=True, blank=True, verbose_name='产品平台')
    type = models.ForeignKey(ProductTypeModel, related_name='product', on_delete=models.CASCADE, default=None,
                             null=True, blank=True, verbose_name='产品类型')
    ...
    # 收费模式1 服务周期
    unified_price_year = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True,
                                             verbose_name='年度统一报价')
