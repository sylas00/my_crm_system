...
class User(AbstractUser):
    phone_num = models.CharField(max_length=20, unique=True, blank=True, verbose_name='手机号码')
    ...
    status = models.IntegerField(default=1, choices=((1, '考核期'), (2, '试用'), (3, '转正'), (4, '休假'), (5, '离职')), verbose_name='用户状态')
    ...
    laoqu_time = models.IntegerField(default=0, null=True, blank=True, verbose_name='捞取待联系次数')
